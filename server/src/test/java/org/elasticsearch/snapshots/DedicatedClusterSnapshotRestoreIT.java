...
public class DedicatedClusterSnapshotRestoreIT extends AbstractSnapshotIntegTestCase {
    ...
    public void testRestoreCustomMetadata() throws Exception {
        ...
        ElasticsearchAssertions.assertThrows(client.admin().cluster().prepareGetRepositories("test-repo"),
    ...
    public void testRestoreIndexWithMissingShards() throws Exception {
        ...
        ElasticsearchAssertions.assertThrows(client().admin().cluster().prepareRestoreSnapshot("test-repo", "test-snap-2")
                .setRestoreGlobalState(false).setWaitForCompletion(true).execute(),
