...
public class PersistentTasksExecutorIT extends ESIntegTestCase {
    ...
    public void testPersistentActionCompletion() throws Exception {
        ...
        if (randomBoolean()) {
            ...
            ElasticsearchAssertions.assertThrows(failedCompletionNotificationFuture, ResourceNotFoundException.class);
    ...
    public void testPersistentActionStatusUpdate() throws Exception {
        ...
        ElasticsearchAssertions.assertThrows(future1, IllegalStateException.class, "timed out after 10ms");
        ...
        ElasticsearchAssertions.assertThrows(failedUpdateFuture, ResourceNotFoundException.class, "the task with id " + taskId +
    ...
    public void testCreatePersistentTaskWithDuplicateId() throws Exception {
        ...
        ElasticsearchAssertions.assertThrows(future2, ResourceAlreadyExistsException.class);
