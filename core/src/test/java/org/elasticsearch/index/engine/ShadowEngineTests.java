...
public class ShadowEngineTests extends ESTestCase {
    ...
    private ParsedDocument testParsedDocument(String id, String type, String routing, long timestamp, long ttl, ParseContext.Document document, BytesReference source, Mapping mappingsUpdate) {
